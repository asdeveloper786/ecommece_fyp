...
<div class="productCommentError2" role="alert">

  </div>
@endif
@if(Session::has('flash_message_success'))

<div class="productCommentSuccess2" role="alert">
              ...
              <div class="card">
                  ...
                  <div class="card-content">
                      <div class="table-responsive">
                          <table class="table table-striped table-bordered table-hover" id="productCommentTable">
                              <thead>
                                  <tr>
                                    <th>Comment ID</th>
                    <th> Name</th>
                    ...
                    <th>Action</th>
                              ...
                              <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="center">{{ $comment->rating }}</td>
                                    ...
                                    @endif
                                    <td>
                                        <form action="{{url('/toggle-approve/{id}')}}" method="POST">
                                            {{csrf_field()}}
                                            <div class="switch">
                                                <label>
...
<script>
 jQuery(function(){
   ...
   window.setTimeout(function() {
    $(".productCommentError2").fadeTo(0, 0).slideUp(0, function(){
        swal({
    position: 'top-end',
  icon: 'error',
  ...
  timer: 3000
       ...
       //productComment Error
       window.setTimeout(function() {
    $(".productCommentSuccess2").fadeTo(0, 0).slideUp(0, function(){
        swal({
    position: 'top-end',
  icon: 'success',
